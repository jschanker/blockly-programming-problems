Blockly.Blocks['largestPowerOfTwoFactor'] = {
  init: function() {
    this.setHelpUrl('http://www.github.com/');
    this.setColour(190);
    this.appendDummyInput('funcName').appendField("largestPowerOfTwoFactorThatIsFactorOf", 'NAME')
...
Blockly.Blocks['printLargestPowerOfTwoFactor'] = {
  init: function() {
    this.setHelpUrl('http://www.github.com/');
    this.setColour(120);
    ...
    this.appendDummyInput().appendField("print(\"Largest power of two that's a factor of\", num, \":\", largestPowerOfTwoFactorThatIsFactorOf(num))");

    this.setTooltip('Print largest power of two that\'s a factor of the number');
