Blockly.Python['largestPowerOfTwoFactor'] = function(block) {
  ...
  var funcName = "largestPowerOfTwoThatIsAFactorOf";
...
Blockly.JavaScript['largestPowerOfTwoFactor'] = function(block) {
...
Blockly.Python['printLargestPowerOfTwoFactor'] = function(block) {
  ...
  */
  ...
  code += "print(\"Largest power of two that's a factor of\", num, \":\", " + funcName + '(' + args.join(', ') + ')' + ")";
  return [code, Blockly.Python.ORDER_FUNCTION_CALL];
};

Blockly.JavaScript['printLargestPowerOfTwoFactor'] = function(block) {
  // Call a procedure with a return value.
  ...
  */
  ...
  code += "alert(\"Largest power of two that's a factor of \" + num + \": \" + " + funcName + '(' + args.join(', ') + ')' + ");\n";  
