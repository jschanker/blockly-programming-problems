Blockly.Python['lgCeil'] = function(block) {
...
Blockly.JavaScript['lgCeil'] = function(block) {
...
Blockly.Python['printSoHeyYo'] = function(block) {
  ...
  */
  ...
  code += "print(\"Ceiling of binary log of\", num, \":\", " + funcName + '(' + args.join(', ') + ')' + ")";
...
Blockly.JavaScript['printSoHeyYo'] = function(block) {
  ...
  */
  ...
  code += "alert(\"Ceiling of binary log of \" + num + \": \" + " + funcName + '(' + args.join(', ') + ')' + ");\n";  
