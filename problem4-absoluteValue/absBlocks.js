Blockly.Blocks['absoluteValue'] = {
  init: function() {
    ...
    this.setColour(190);
    this.appendDummyInput('funcName').appendField("absoluteValue", 'NAME')
                                     .appendField("(x)", 'PARAMSA');
...
Blockly.Blocks['printAbsoluteValue'] = {
  init: function() {
    this.setHelpUrl('http://www.github.com/');
    this.setColour(120);
    this.appendDummyInput()
        .appendField("num = ")
        .appendField(new Blockly.FieldTextInput("-3.14159"), 'NUM');
    this.appendDummyInput().appendField("print(\"Absolute value of\", num, \":\", absoluteValue(num))");
